...
const SalesChart = () => {
  const [DataSet, setDataSet] = useState(['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun']);
  ...
  return (
    ...
    <div className="p-5 flex justify-between items-center">
      ...
      <div className="">
        <button className="py-2 px-3 rounded-tl rounded-bl border border-solid border-gray-400">Month</button>
        <button className="py-2 px-3 rounded-tr rounded-br border border-solid border-gray-400 bg-blue-300 border-l-0">Week</button>
       </div>
    </div>
      <div
       className="p-3 border-blue-200 border-t border-solid sales-chart-size-response">
       <Line
        height={80}
        width={300}
        data={data}
