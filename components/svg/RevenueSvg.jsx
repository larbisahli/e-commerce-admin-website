...
const RevenueSvg = (props) => {
  return (
    <svg {...props} aria-hidden="true" focusable="false" data-prefix="fas" data-icon="cash-register" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
