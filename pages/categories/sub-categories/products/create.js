...
const NewProduct = ({ token, userInfo }) => {
    ...
    console.log(`ImagesUrlInput`, ImagesUrlInput)
                ...
                <div className="shadow overflow-hidden md:rounded-lg card-container rounded-none">
                    ...
                    <div className="px-4 py-5 bg-white sm:p-6">
                        <div className="block">
                            ...
                            <div className="mb-4">
                                <label htmlFor="first_name" className="block text-sm font-medium text-gray-700">
                                    Discount <span className="text-sm text-gray-500">(USD)</span>
                                </label>
                                <input
                                    type="number"
                                    name="first_name"
                            ...
                            {/* --thumbnail-- */}
                            <div className="pt-3 border-t-2 border-solid border-gray-100 mt-3">
                                <div className="block text-sm font-medium text-gray-700">Thumbnail Image</div>
                                {/* -- URL -- */}
                                <div className="mb-4">
                                    <input
                                        type="text"
                                ...
                                <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 border-dashed rounded-md">
                                    <div className="space-y-1 text-center w-full">
                                        ...
                                        <p className="text-xs text-gray-500">PNG, JPG, ((make sur it&#39;s high-resolution))</p>
                                    </div>
                                </div>
                            </div>
                            {/* --images_url-- */}
                            <div className="pt-3 border-t-2 border-solid border-gray-100 mt-7">
                                <div className="block text-sm font-medium text-gray-700">Product Images Showcase</div>
                                {/* -- URL -- */}
                                    ...
                                    shadow-sm border-2 border-solid border-gray-300 rounded-md p-1"
                                        ...
                                        <div role="button" onClick={() => {
                                            ...
                                            <span className="bg-green-400 rounded-sm px-2 py-1 text-white cursor-pointer">
                                                <Add width={18} height={18} /></span>
                                        </div>
                                    </div>
                                    <div className="flex justify-center flex-wrap items-center">
                                        {ImagesUrl?.map((url, index) => (
                                            <div key={index} className="card-container rounded m-2">
                                                <div style={{ width: '100px' }}><img className="rounded-t" src={url} alt="" width="100" height="100" /></div>
                                                <div className="flex justify-center rounded-b border-gray-300 border-solid items-center">
                                                    <div
                                                        ...
                                                        onClick={() => {
                                                            if (ImagesUrlInput.length === 0) {
                                                                ...
                                                                setTimeout(() => setImageUrlError(false), 8000)
                                                            } else {
                                                                setImagesUrl((prev) => prev.map((_url) => {
                                                                    if (_url === url) {
                                                    ...
                                                    <div
                                                        ...
                                                        onClick={() => {
                                                            setImagesUrl((prev) => prev.filter((_url) => _url !== url))
                                                        }}>Remove</div>
                                                </div>
                                            </div>
                                        ))}
                                    </div>
                                    {ImageUrlError && <div className="flex justify-center items-center m-1 font-medium py-1 px-2 rounded-md text-red-700 bg-red-100 border border-red-300 ">
                                        <div slot="avatar">
                                        ...
                                        <div className="text-sm font-normal  max-w-full flex-initial">
                                            You can&#39;t update if the Url input is empty.</div>
                                        <div className="flex flex-auto flex-row-reverse">
                                            <div role="button" className="ml-2 cursor-pointer" onClick={() => setImageUrlError(false)}>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeXidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-x cursor-pointer hover:text-red-400 rounded-full w-5 h-5 ml-2">
                                    ...
                                    >
                                        {({
                                            ...
                                            <div className="flex justify-center items-center flex-col mb-3">
                                                ...
                                                <div role="button" className="text-red-700 text-sm cursor-pointer hover:underline" onClick={onImageRemoveAll}>Remove all images</div>
                                            </div>
                                            <div className="flex justify-center flex-wrap items-center">
                                                {imageList.map((image, index) => (
                                                    <div key={index} className="card-container rounded m-2">
                                                        <div style={{ width: '100px' }}><img className="rounded-t" src={image['data_url']} alt="" width="100" height="100" /></div>
                                                        <div className="flex justify-center rounded-b border-gray-300 border-solid items-center">
                                                            <div
                                                                role="button"
                                                                className="rounded-bl cursor-pointer text-xs bg-green-400 w-full p-1 text-center border-gray-300 border-solid border-r hover:bg-green-500 text-white"
